...
`knowledge/approved_facts.json` contains the 49 facts that may be used as answers,
...
regression set contains 92 cases. Routing and posting are autonomous; staff
